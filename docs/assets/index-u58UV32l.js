    ...
    <section id="inicio" class="hero-section" style="--hero-image: url('${e}')">
      ...
      <div class="hero-presentation">
        <div class="hero-brand-view">
          <div class="hero-brand-symbol">${B()}</div>
          ${z(`brand-mark--hero`)}
